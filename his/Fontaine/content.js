...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const MD_PARTS = [];
    // __MD_PARTS_START__
    MD_PARTS.push(String.raw`# 第四章：枫丹·罪人舞步旋
...
|派系|人物|介绍|
|---|---|---|
|领导层|莉莉丝<sup>3</sup>|纯水精灵，水仙十字院院长<br>在厄里那斯遗骸的决战中溶解并吸收了濒死的玛丽安·吉约丹，化身纯水精灵「玛丽安」并回到十字院遗址建立安眠处和水仙十字王国|
...
·雷内为了救雅各布，将深渊力用在雅身上，雅各布进化

·雷内、雅各布各布返回枫丹，雷内推导出「世界式」，预言终末的灾祸
...
他找到剑（钥匙），以割舍并统合意志，说服了院长，提炼并保存了卡特的意识。
...
阿兰加入并离开逐影庭，并最终枫丹建立动能工程科学研究院。（为逐影庭或特巡队所收留，为了不让王国再度蒙上阴影而精进）
